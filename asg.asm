...
user 		db 	"taruc"
password 	db 	"12345"
welcome		db 	"Welcome to Doi Doi Calculator, please enter your username: $"
errorMsg 	db 	"Error, user name not match. $"
errorPsd 	db	"Error, password not match. $"
gratz 		db 	"Congratulations! now you can start using the calculator.$"
msgPass		db	"Enter your password: $"
...
msgUsedTimes 	db "Number of times you have used this calculator: $"
msgEndProg		DB 		"Your calculation is completed.", 10, 13
				DB		"Thank you for using doi doi claculator.", 10, 13
				DB		"All the best in your future!!$"
